...
public class WebEventListener extends GlobalVars
		implements
	...
	public void afterChangeValueOf(WebElement element, WebDriver driver) {
		// System.out.println("Element value changed to: " +
		// element.toString());
	}
	...
	public void onException(Throwable error, WebDriver driver) {
		...
		// MDB_Utils.takeScreenshotAtEndOfTest();
		// bw.CloseBrowser();
		// GlobalIdMDBSuite.takeScreenshotAtEndOfTest();
	...
	public void onTestSuccess(ITestResult result) {
		...
		if (Status.equalsIgnoreCase("passed")) {
			...
			System.out.println("Test case: " + TestName + " is Failed");
			bw.CloseBrowser();
		}
